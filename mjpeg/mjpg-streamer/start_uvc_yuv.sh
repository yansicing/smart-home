...
WEBSERVER=./
./mjpg_streamer -o "output_http.so -w ./www" -i "input_s3c2410.so" -p 8000
...
#$WEBSERVER/mjpg_streamer -o  "$WEBSERVER/output_http.so -p 8000 -w $WEBSERVER/www" -i "$WEBSERVER/input_testpicture.so"
