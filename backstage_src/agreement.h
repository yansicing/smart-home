...
#define SUNHOME_TEMP_HUMI_GET_CMD			201		/*温湿度获取*/

#define SUNHOME_GPRS_SEND_MSG_CMD			301		/*发送短信*/
#define SUNHOME_GPRS_CALL_CMD				302		/*拨打电话*/
#define SUNHOME_GPRS_HANG_UP_CMD			303		/*挂断电话*/

#define SUNHOME_LOCAL_IP_SET_CMD			401		/*本地IP设置*/
#define SUNHOME_LOCAL_IP_GET_CMD			402		/*本地IP获取*/

#define SUNHOME_MPLAYER_PAUSE_CMD			501		/*Mplayer暂停*/
#define SUNHOME_MPLAYER_VOLUME_CMD			502		/*Mplayer音量设置*/
#define SUNHOME_MPLAYER_CHANGESONG_CMD		503		/*Mplayer切换歌曲*/
#define SUNHOME_MPLAYER_GET_SONGLIST_CMD	504		/*Mplayer获取歌曲列表*/
#define SUNHOME_MPLAYER_START_CMD			505		/*启动Mplayer*/
#define SUNHOME_MPLAYER_VOLUME_ADD			506		/*Mplayer音量增加*/
#define SUNHOME_MPLAYER_VOLUME_SUB			507		/*Mplayer音量减少*/
...
/************判断字符串是否为协议包********
*如果头部正确，表示协议包正确，返回0，否则返回-1
********************************************/
extern int sunhome_check_bag_is_right(const char *bag);
